...
def parse_args():
    ...
    parser.add_argument('--comm_noise_rate', type=float, default='0', help='comm noise')
    parser.add_argument('--neighbor_noise_rate', type=float, default='0', help='neighbor noise')
    parser.add_argument('--direct', type=float, default='0', help='direct 1, undirect 0')
